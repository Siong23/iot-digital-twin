/*
 * Fast Telnet Brute Force C Extension - Cross-Platform
 * Educational Purpose Only - For Controlled Lab Environment
 * 
 * This C extension provides high-performance telnet brute-forcing
 * with multi-threading and optimized socket operations.
...
// Set socket timeout (cross-platform)
...
#endif
                telnet_thread_worker, &thread_data) == 0) {
