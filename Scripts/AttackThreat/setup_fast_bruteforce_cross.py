#!/usr/bin/env python3
"""
Cross-Platform Setup Script for Fast Telnet Brute Force C Extension
...
def main():
    print("=" * 60)
    print("Fast Telnet Brute Force C Extension - Cross-Platform Setup")
    print("=" * 60)
    ...
    telnet_bruteforce_ext = Extension(
        'fast_telnet_bruteforce',
        sources=['fast_telnet_bruteforce_cross.c'],
        **compile_args
    )
    ...
    setup(
        ...
        version='1.0',
        description='High-performance telnet brute force module',
        ext_modules=[telnet_bruteforce_ext],
        zip_safe=False
    )
