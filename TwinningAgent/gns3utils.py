...
def stop_capture_all_iot_links(server, project, switches_pattern: Pattern=re.compile("fixedopenvswitch.*", re.IGNORECASE), iot_pattern: Pattern=re.compile("mqtt-device.*|coap-device.*", re.IGNORECASE)) -> None:
