...
# Set Qt plugin paths for PyQt5
CONDA_PREFIX = os.environ.get("CONDA_PREFIX", "/home/fl/anaconda3")
os.environ["QT_PLUGIN_PATH"] = os.path.join(CONDA_PREFIX, "plugins")
os.environ["QT_QPA_PLATFORM_PLUGIN_PATH"] = os.path.join(CONDA_PREFIX, "plugins", "platforms")
...
class Dashboard(QWidget):
    def __init__(self, mqtt_client):
        super().__init__()
        self.setWindowTitle("Physical Twin IoT Dashboard")
